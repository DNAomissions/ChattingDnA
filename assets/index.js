...
$(document).ready(function(){
  socket.on('chat message', function(msg){
    if(msg.from == Cookies.get("name")){
      $('#chatResult').append(`<li class="wowload fadeIn speech-bubble-right"><pre style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';font-size: 1rem;font-weight: 400;  line-height: 1.5;color: #212529;text-align: left;"><span class="sender-chat">Me</span><br><span class="divider-chat-bubble"></span><p class="message-chat">`+msg.message+`</p><span class="time-chat">`+msg.time+`</span></pre></li>`);
    }else{
